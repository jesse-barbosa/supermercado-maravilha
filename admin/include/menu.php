<div class="col">
    <div class="d-flex flex-row text-center">
        <div class="text-start my-auto ms-3 my-3 lead text-dark">
            ...
            <span class='ms-3 fw-normal'><?php echo $_SESSION['nome']; ?></span>
        </div>
    </div>
</div>
<ul class="nav flex-column">
    ...
    <div class="d-none d-md-inline-block text-start my-2 text-dark fs-5 text-center lead">Cadastros
    </div>
    <a class="d-none d-md-inline-block link-underline link-underline-opacity-0 link-dark link-opacity-75-hover"
    ...
    <div class="d-none d-md-inline-block text-start my-2 text-dark fs-5 text-center lead">Relatórios</div>
    ...
    <div class="d-none d-md-inline-block text-start my-2 text-dark fs-5 text-center lead">Administrador</div>
    <a class="d-none d-md-inline-block link-underline link-underline-opacity-0 link-dark link-opacity-75-hover"
